...
def test_handoff_latest_is_overnight_57_hygiene() -> None:
    assert "## Latest: Overnight #57" in HANDOFF
    assert "PR #65" in _latest_section()
    assert "15b3a47" in _latest_section()
