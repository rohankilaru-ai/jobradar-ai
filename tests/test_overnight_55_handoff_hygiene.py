...
def test_handoff_latest_is_overnight_55_hygiene() -> None:
    assert "## Latest: Overnight #55" in HANDOFF
    assert "PR #63" in _latest_section()
    assert "b274824" in _latest_section()
