...
def test_handoff_latest_is_overnight_56_hygiene() -> None:
    assert "## Latest: Overnight #56" in HANDOFF
    assert "PR #64" in _latest_section()
    assert "e1e7219" in _latest_section()
